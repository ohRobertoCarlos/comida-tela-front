<template>
  <div style="position: relative;">
    ...
    <div v-if="establishment.profile && (establishment.profile.facebook_link || establishment.profile.instagram_link || establishment.profile.whatsapp)" class="social-icons">
